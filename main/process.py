...
def training(config, SCENARIOS, test_mode):
    ...
    while True:
        ...
        print(Storyboard.LOG_TEMPLATE_LOW.format(teamName, Storyboard.STEP_TEMPLATE.format(STEP[Storyboard.LABEL_KEY],
                                                                                           "[Executing...]")))
        ...
        if test_mode and trigger[Storyboard.MODULE_KEY] not in allowed_test_mode_triggers:
            print("[-] process: WARNING: Trigger module replaced in test mode: '{0}' => '{1}'".format(
        ...
        if test_mode and action[Storyboard.MODULE_KEY] not in allowed_test_mode_actions:
            print("[-] process: WARNING: Action module replaced in test mode: '{0}' => '{1}'".format(
        ...
        while True:
            ...
            logger.info(
                u"{0:>16} | {1:>16} | Waiting trigger {2}".format(teamName, step, trigger[Storyboard.MODULE_KEY]))
            ...
            print(Storyboard.LOG_TEMPLATE_LOW.format(teamName,
                                                     Storyboard.STEP_TEMPLATE.format(STEP[Storyboard.LABEL_KEY],
                                                                                     comment)))
